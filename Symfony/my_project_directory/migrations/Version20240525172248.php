 ...
 */
final class Version20240525172248 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE recipe (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title CLOB NOT NULL, slug CLOB NOT NULL, content CLOB , created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
    ...
    public function down(Schema $schema): void
    {
        ...
        , duration INTEGER NOT NULL, nb_personne INTEGER DEFAULT NULL, ingredients CLOB DEFAULT NULL)');
        $this->addSql('INSERT INTO recipe (id, title, slug, content, created_at, duration, nb_personne, ingredients) SELECT id, title, slug, content, created_at, duration, nb_personne, ingredients FROM __temp__recipe');
        $this->addSql('DROP TABLE __temp__recipe');
    }
}
